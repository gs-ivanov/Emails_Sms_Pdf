...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Emails_Sms_Pdf.Data.MatchSubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Emails_Sms_Pdf.Data.Models.Manager", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Emails_Sms_Pdf.Data.Models.ManagerRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Emails_Sms_Pdf.Data.Models.Match", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Emails_Sms_Pdf.Data.Models.Ranking", b =>
                {
            ...
            modelBuilder.Entity("Emails_Sms_Pdf.Data.Models.Team", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Emails_Sms_Pdf.Data.Models.Emails_Sms_Pdf", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Emails_Sms_Pdf.Data.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Emails_Sms_Pdf.Models.Teams.TeamViewModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Emails_Sms_Pdf.Data.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Emails_Sms_Pdf.Data.MatchSubscription", b =>
                {
                    b.HasOne("Emails_Sms_Pdf.Data.Models.Match", "Match")
                        .WithMany()
                        .HasForeignKey("MatchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Emails_Sms_Pdf.Data.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("Emails_Sms_Pdf.Data.Models.ManagerRequest", b =>
                {
                    b.HasOne("Emails_Sms_Pdf.Data.Models.Team", "Team")
                        .WithMany()
                        .HasForeignKey("TeamId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Emails_Sms_Pdf.Data.Models.Team", null)
                        .WithMany("ManagerRequests")
                        .HasForeignKey("TeamId1");

                    b.HasOne("Emails_Sms_Pdf.Data.Models.Emails_Sms_Pdf", "Emails_Sms_Pdf")
                        .WithMany()
            ...
            modelBuilder.Entity("Emails_Sms_Pdf.Data.Models.Match", b =>
                {
                    b.HasOne("Emails_Sms_Pdf.Data.Models.Team", "TeamA")
                        .WithMany("MatchesAsTeamA")
                        .HasForeignKey("TeamAId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Emails_Sms_Pdf.Data.Models.Team", "TeamB")
            ...
            modelBuilder.Entity("Emails_Sms_Pdf.Data.Models.Team", b =>
                {
                    b.HasOne("Emails_Sms_Pdf.Data.Models.Emails_Sms_Pdf", null)
                        .WithMany("Teams")
                        .HasForeignKey("TournamentId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Emails_Sms_Pdf.Models.Teams.TeamViewModel", b =>
                {
                    b.HasOne("Emails_Sms_Pdf.Data.Models.Manager", null)
                        .WithMany("Teams")
